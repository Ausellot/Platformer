if(place_meeting(x,y,obj_player)){
	...
	if (!playerTurn) && (!showBattleText){
		...
		if (enemytimer >= timeTillEnemyAttacks){
			...
			ds_messages[|0] = "Flashy Fox Attacks";
			battleOption = 0;
			...
			if(roll == "Hits"){
				dmg = irandom(1) + 1;
				ds_messages[|1] = "Tambourine Tackle hits for "	+ string(dmg) + " damage!";
				
			}else{
				dmg = irandom(1) + 2;
				ds_messages[|1] = "Tambourine Tempo hits for "	+ string(dmg) + " damage!";
			}
		}
	}
